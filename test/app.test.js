...
describe('App', () => {
  ...
  describe('placeOrder', () => {
     ...
     */
    it('placing order resolves with correct message', async ()=>{
      const orderedItems = {'Leckeres Eis': 2, 'Pizza': 3};
      const locale = 'de';
      let expectedMessage = 'Thank you for dining with Schnell Imbiss! Here is your order of: 2 x Leckeres Eis 3 x Pizza. Your total is: 26,50 €.'
      
      const result = await placeOrder(orderedItems,locale)
